...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // -----------------------
  {
    ...
    if (appSidebar && sidebarColorModes && sidebarColor && sidebarColorCode) {
      sidebarColor.innerHTML =
        `<option value="">---Select---</option>` +
        themeBg.map((bg) => `<option value="${bg}">${bg}</option>`).join('');
      ...
      sidebarColor.addEventListener('input', (event) => {
        ...
        themeBg.forEach((c) => appSidebar.classList.remove(c));
        if (themeBg.includes(sidebarBg)) appSidebar.classList.add(sidebarBg);
  ...
  // -----------------------
  {
    ...
    if (appNavbar && navbarColorModes && navbarColor && navbarColorCode) {
      navbarColor.innerHTML =
        `<option value="">---Select---</option>` +
        themeBg.map((bg) => `<option value="${bg}">${bg}</option>`).join('');
      ...
      navbarColor.addEventListener('input', (event) => {
        ...
        themeBg.forEach((c) => appNavbar.classList.remove(c));
        if (themeBg.includes(navbarBg)) appNavbar.classList.add(navbarBg);
  ...
  // -----------------------
  {
    ...
    if (appFooter && footerColorModes && footerColor && footerColorCode) {
      footerColor.innerHTML =
        `<option value="">---Select---</option>` +
        themeBg.map((bg) => `<option value="${bg}">${bg}</option>`).join('');
      ...
      footerColor.addEventListener('input', (event) => {
        ...
        themeBg.forEach((c) => appFooter.classList.remove(c));
        if (themeBg.includes(footerBg)) appFooter.classList.add(footerBg);
